...
/****************************************************************************
*
* $Id: NewVpViper.cpp 4206 2013-04-13 07:29:06Z fspindle $
*
...
const unsigned int NewVpViper::njoint = 6;
...
*/
vpHomogeneousMatrix
NewVpViper::getForwardKinematics(const vpColVector & q)
{
...
*/
bool
NewVpViper::convertJointPositionInLimits(unsigned int joint, const double &q, double &q_mod, const bool &verbose)
{
	double eps = 0.01;
...
/*
unsigned int
NewVpViper::getInverseKinematicsWrist(const vpHomogeneousMatrix & fMw, vpColVector & q, const bool &verbose)
{
	vpColVector q_sol[8];
...
/*
unsigned int
NewVpViper::getInverseKinematics(const vpHomogeneousMatrix & fMc, vpColVector & q, const bool &verbose)
{
	vpHomogeneousMatrix fMw;
...
*/
vpHomogeneousMatrix
NewVpViper::get_fMc(const vpColVector & q)
{
	vpHomogeneousMatrix fMc;
	get_fMc(q, fMc);
...
*/
void
NewVpViper::get_fMc(const vpColVector & q, vpHomogeneousMatrix & fMc)
{
...
*/
void
NewVpViper::get_fMe(const vpColVector & q, vpHomogeneousMatrix & fMe)
{
	double q1 = q[0];
	double q2 = q[1];
	double q3 = q[2];
...
*/
void
NewVpViper::get_fMw(const vpColVector & q, vpHomogeneousMatrix & fMw)
{
	double q1 = q[0];
	double q2 = q[1];
	double q3 = q[2];
...
*/
void
NewVpViper::get_wMe(vpHomogeneousMatrix & wMe)
{
...
*/
void
NewVpViper::get_eMc(vpHomogeneousMatrix &eMc)
{
	eMc = this->eMc;
}

void NewVpViper::get_eMs(vpHomogeneousMatrix & eMs)
{
}
...
*/
void
NewVpViper::get_cMe(vpHomogeneousMatrix &cMe)
{
...
*/
void
NewVpViper::get_cVe(vpVelocityTwistMatrix &cVe)
{
...
*/
void
NewVpViper::get_eJe(const vpColVector &q, vpMatrix &eJe)
{
	vpMatrix V(6, 6);
	V = 0;
...
void
NewVpViper::get_fJw(const vpColVector &q, vpMatrix &fJw)
{
	double q1 = q[0];
	double q2 = q[1];
	double q3 = q[2];
...
*/
void
NewVpViper::get_fJe(const vpColVector &q, vpMatrix &fJe)
{
	vpMatrix V(6, 6);
	V = 0;
...
*/
double
NewVpViper::getCoupl56()
{
	return c56;
}

void
NewVpViper::setSamplingTime(double SamplingTime)
{
	_SamplingTime = SamplingTime;
}

double
NewVpViper::getSamplingTime()
{
	return _SamplingTime;
}

void
NewVpViper::get_q(const vpColVector& CamVel, vpColVector& q)
{
	vpMatrix fJe;
	get_fJe(q, fJe);
	vpColVector qdot = fJe.pseudoInverse() * CamVel;
	//q += _SamplingTime * qdot;
	std::cout << "This is previous q: " << q << "\n\n";
	q = q + _SamplingTime * qdot;
	//std::cout << "This is sampling time: " << _SamplingTime << "\n\n";
	//std::cout << "This is qdot: " << qdot << "\n\n";
	std::cout << "This is qdot with sampleing time: " << _SamplingTime * qdot << "\n\n";
	std::cout << "This is new q: " << q << "\n\n";
}
...
*/
std::ostream & operator << (std::ostream & os, const NewVpViper & viper)
{
...
* End:
*/
//=================================================must be deleted below
//
//
//const std::string vpAfma6::CONST_AFMA6_FILENAME = std::string(VISP_AFMA6_DATA_PATH) + std::string("/include/const_Afma6.cnf");
//
...
//}
//
//std::ostream& operator<<(std::ostream& os, const vpAfma6& afma6)
//{
//    vpRotationMatrix eRc;
